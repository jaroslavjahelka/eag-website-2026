...
- use semantic roles instead of raw color names where possible
...
They expose the stable foundation of the system without forcing component code to depend on raw scale tokens.
