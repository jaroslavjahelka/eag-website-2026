...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "home.contact.success.title": "Message sent!",
    "home.contact.success.body": "Thank you for reaching out. We'll get back to you soon.",
    "home.contact.success.another": "Send another message",
    "home.contact.error.general": "Please fix the errors below and try again.",
    "home.contact.error.name": "Please enter your full name.",
    "home.contact.error.email": "Please enter a valid email address.",
    "home.contact.error.message": "Your message should be at least 10 characters.",
    "home.contact.error.server": "Something went wrong while sending your message. Please try again later.",
  ...
  cs: {
    ...
    "home.contact.success.title": "Zpráva odeslána!",
    "home.contact.success.body": "Děkujeme za váš zájem. Ozveme se vám co nejdříve.",
    "home.contact.success.another": "Odeslat další zprávu",
    "home.contact.error.general": "Opravte prosím chyby níže a zkuste to znovu.",
    "home.contact.error.name": "Zadejte prosím celé jméno.",
    "home.contact.error.email": "Zadejte prosím platnou e-mailovou adresu.",
    "home.contact.error.message": "Zpráva musí mít alespoň 10 znaků.",
    "home.contact.error.server": "Při odesílání zprávy došlo k chybě. Zkuste to prosím později.",
